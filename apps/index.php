...
<meta name="viewport" content="width=device-width, initial-scale=1"> 
    ...
    <meta property="og:url" content="https://toremetal.com/apps/">
    ...
    <meta itemprop="url" content="https://toremetal.com/apps/">
...
<link rel="canonical" href="https://toremetal.com/apps/index.php"> 
...
<body style="background-color:#29292990">
    <div id="fb-root"></div>
...
<ul class="ampstart-social-follow list-reset flex justify-around items-left flex-wrap m0 mb0">
...
<br><li><a title='Home' href="/home">HOME</a></li>
<li><a title='Apps on ™T©ReMeTaL' href="/apps">APPS</a></li>
<li><a title='Log In' href="/androids/createaccount/"><?=$login?></a></li>
<li></li></ul>
	...
	<div class="container"> 
        ...
        <!--<div class="section app-content contactus" style="background-color:#FFFFFF90; align:justify; font-size:1.00rem; white-space:wrap; padding:var(--universal-padding) calc(4 * var(--universal-padding))">-->
	<div class="row" style="align:center; font-size:1.00rem; white-space:wrap; padding:var(--universal-padding) calc(4 * var(--universal-padding))">
<?php
if (isset($_COOKIE['devt'])) {
    $devname=$_COOKIE['devt'];
    if (file_exists('../androids/sub/devs/' . $devname)) {
		$file = fopen('../androids/sub/devs/' . $devname, 'r');
		echo '<div class="section app-content contactus" style="background-color:#FFFFFF90; align:justify; font-size:1.00rem; white-space:wrap; padding:var(--universal-padding) calc(4 * var(--universal-padding))"><h1>'.$devname.'</h1><div class="row" style="align:center; font-size:1.00rem; white-space:wrap; padding:var(--universal-padding) calc(4 * var(--universal-padding))">';
    ...
    $directory = "../androids/sub/devs/";
    $dir = opendir($directory);
    $file_array = array(); 
    while (($file = readdir($dir)) !== false) {
        if (!strcasecmp($file, 'index.php')==0) {
        if (!strcasecmp($file, '.')==0) {
            if (!strcasecmp($file, '..')==0) {
                $filename = $directory . $file;
                $contents = file_get_contents($filename);
                $sy="'";
         	echo '<div class="section app-content contactus" style="background-color:#FFFFFF90; align:justify; font-size:1.00rem; white-space:wrap; padding:var(--universal-padding) calc(4 * var(--universal-padding))"><h1><a title="'.$file.' Apps" onclick="setDev('.$sy.$file.$sy.')" href="">'.$file.'</a></h1><div class="row" style="align:center; font-size:1.00rem; white-space:wrap; padding:var(--universal-padding) calc(4 * var(--universal-padding))">'.$contents .'</div></div>';
            }
        }
        }
    }
...
<script>
    ...
    document.cookie = "devt=" + (value || "") + expires + ";path=/apps/;domain=<?=$hst?>;SameSite=Strict";
}
</script>
    </div> 
        <!--</div>--> 
...
<div align="center" style="height:100%;width:100%;align:bottom|center;">
...
return d.getFullYear();
      ...
      <div style="text-align: left;position: fixed;z-index:9999999;bottom: 0;width: auto;right: 0%;cursor: pointer;line-height: 0;display:block !important;">

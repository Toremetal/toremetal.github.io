...
<span class="h1 block bold caps my1">App Submissions</span><hr/>
                        ...
                        <div class="address">
                            ...
                            <form id="myForm">
                                <div class="row">
                                    ...
                                    <div class="col-sm-12">
<input style="width:0%" class="hidden" id='dev' class="contactus" placeholder="Developer Name" type="text" name="developer" value="<?=$_COOKIE[$cookie_name]?>"><h3>Developer: <?=$_COOKIE[$cookie_name]?></h3>
                                    </div>
                                    <div class="col-sm-12">
<input style="width:100%" id='app' class="contactus" placeholder="app" type="text" name="app">
                                    </div>
                                    <div class="col-sm-12">
...
<input class="contactus" id='img' style="width:100%" placeholder="Image Embed Link" type="url" name="image">
                                    ...
                                    <div class="col-sm-12">
<textarea class="textarea" id='des' style="width:100%" placeholder="Short Description" type="text" name="shortDescription"></textarea>
                                    </div>
                                    <div class="col-sm-12">
<textarea class="textarea" id='fdes' style="width:100%" placeholder="Full Description" type="text" name="Description"></textarea>
                                    </div>
                                    <div class="col-sm-12">
<button onclick="setCookie('app','value',0)" formaction="/androids/" method='get' class="send">Submit</button>
                                    </div>
                                 </div>                              
                            </form>
                        </div>
